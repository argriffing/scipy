...
class CorrelationFunctions(Benchmark):
    ...
    def time_fisher_exact(self, alternative):
        if alternative == 'two-sided':
            oddsratio, pvalue = stats.fisher_exact(self.a, alternative='two-sided')
        elif alternative == 'less':
            oddsratio, pvalue = stats.fisher_exact(self.a, alternative='less')
        else:
            oddsratio, pvalue = stats.fisher_exact(self.a, alternative='greater')
